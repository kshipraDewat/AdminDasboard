                    ...
                    <tbody className='divide-y divide-gray-700  '>
                        {filteredUsers.map(user => (
                            <motion.tr key={user.id} initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.3 }}>
                                <td className='cursor-default px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-100 flex  gap-2 items-center'>
                                ...
                                <td className='cursor-default px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-300 '>
                                    {user.email}
                                </td>
                                <td className='cursor-default px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-300 '>
